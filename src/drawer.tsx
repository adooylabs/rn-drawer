...
import { IProps } from '../../interfaces/drawer';
...
class Drawer extends Component <IProps, {}>{
  ...
  // TODO: change is to GetDerivedStateFromProps
  componentWillMount() {
    const {
      drawerWidth,
      drawerPosition,
  ...
  componentDidUpdate({ open }) {
    if((this.props.open === false) && (open === true)) {
      this.closeDrawer();
    } else if ((this.props.open === true) && (open === false)){
      this.openDrawer();
    }
  }
    ...
    return (
      <View style={styles.container}>
        <View
          ...
          style={[styles.main, customStyles.main]}
